...
## Scoring Engine Implications
- Talent: Director weight (55%) > Actor weight (45%) — inverted from earlier.
- Genre breadth is expanding — be less punitive on genre risk.
- Market timing weight increased from 7% → 8%.
- Pre-sale coverage up to 80% is achievable for strong projects.
- Theatrical share default: 40% (was 50%).
